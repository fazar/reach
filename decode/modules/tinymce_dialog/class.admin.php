<?php
	class DC_tinymce_dialog_admin{
		...
		function register_scripts(){
			$plugin_array['dc_editor_helper'] =   DC_BASE_URL .'js/tinymce-button.js';
			return $plugin_array;
		}

		function register_buttons( $buttons ){
			array_push( $buttons, 'dc_editor_helper', 'dropcap' );
			return $buttons;
		}

		function dialog_content(){
			?>
			<div id="dc_editor_helper" style="display:none">
				<div class="header">
						...
						<tr>
							...
							<td>
								<select id="select-component" class="widefat">
									<?php do_action('dc_helper_options') ?>
								</select>
							</td>
						</tr>
					</table>
				...
				<div class="active-area">
					<?php do_action('dc_helper_active') ?>
				</div>
				<div class="hidden-area">
					<?php do_action('dc_helper_hidden') ?>
				</div>
			</div>
			<?php
		}
		...
		function editor_style(){
			add_editor_style( DC_BASE_URL .'css/admin-style.css' );
		}
