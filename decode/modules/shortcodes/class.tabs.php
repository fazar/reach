<?php
	class DC_shortcodes_tabs{
		function __construct(){
			add_shortcode('dc_tabs', array($this, 'display_tabs'));
			add_shortcode('dc_tab', array($this, 'display_tab'));
			global $tab_header;
			global $tab_content;
			$tab_header = 0;
			$tab_content = 0;
		...
		function display_tabs($atts, $content){
			...
			ob_start();
			$content_header = str_replace('[dc_tab', '[dc_tab is_header="1"', $content);
			?>
